...
/* BOTÃO COMEÇAR */
document.getElementById("btnComecar").onclick = () => trocarTela("tela1","tela2");
...
document.getElementById("okNome").onclick=()=>{
...
/* DATA */
document.getElementById("okData").onclick=()=>{
